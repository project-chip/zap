 ...
 *                       \______/  \______/                               
 */
CREATE TRIGGER IF NOT EXISTS "INSERT_TRIGGER_SESSION_KEY_VALUE" AFTER INSERT ON "SESSION_KEY_VALUE" BEGIN 
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "UPDATE_TRIGGER_SESSION_KEY_VALUE" AFTER UPDATE ON "SESSION_KEY_VALUE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "DELETE_TRIGGER_SESSION_KEY_VALUE" AFTER DELETE ON "SESSION_KEY_VALUE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = OLD.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "INSERT_TRIGGER_SESSION_LOG" AFTER INSERT ON "SESSION_LOG" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "UPDATE_TRIGGER_SESSION_LOG" AFTER UPDATE ON "SESSION_LOG" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "DELETE_TRIGGER_SESSION_LOG" AFTER DELETE ON "SESSION_LOG" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = OLD.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "INSERT_TRIGGER_ENDPOINT_TYPE" AFTER INSERT ON "ENDPOINT_TYPE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "UPDATE_TRIGGER_ENDPOINT_TYPE" AFTER UPDATE ON "ENDPOINT_TYPE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "DELETE_TRIGGER_ENDPOINT_TYPE" AFTER DELETE ON "ENDPOINT_TYPE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = OLD.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "INSERT_TRIGGER_ENDPOINT" AFTER INSERT ON "ENDPOINT" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "UPDATE_TRIGGER_ENDPOINT" AFTER UPDATE ON "ENDPOINT" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "DELETE_TRIGGER_ENDPOINT" AFTER DELETE ON "ENDPOINT" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = OLD.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "INSERT_TRIGGER_ENDPOINT_TYPE_CLUSTER" AFTER INSERT ON "ENDPOINT_TYPE_CLUSTER" BEGIN
...
CREATE TRIGGER IF NOT EXISTS "UPDATE_TRIGGER_ENDPOINT_TYPE_CLUSTER" AFTER UPDATE ON "ENDPOINT_TYPE_CLUSTER" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = NEW.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "DELETE_TRIGGER_ENDPOINT_TYPE_CLUSTER" AFTER DELETE ON "ENDPOINT_TYPE_CLUSTER" BEGIN
...
CREATE TRIGGER IF NOT EXISTS "INSERT_TRIGGER_ENDPOINT_TYPE_ATTRIBUTE" AFTER INSERT ON "ENDPOINT_TYPE_ATTRIBUTE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = NEW.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "UPDATE_TRIGGER_ENDPOINT_TYPE_ATTRIBUTE" AFTER UPDATE ON "ENDPOINT_TYPE_ATTRIBUTE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = NEW.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "DELETE_TRIGGER_ENDPOINT_TYPE_ATTRIBUTE" AFTER DELETE ON "ENDPOINT_TYPE_ATTRIBUTE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = OLD.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "INSERT_TRIGGER_ENDPOINT_TYPE_COMMAND" AFTER INSERT ON "ENDPOINT_TYPE_COMMAND" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = NEW.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "UPDATE_TRIGGER_ENDPOINT_TYPE_COMMAND" AFTER UPDATE ON "ENDPOINT_TYPE_COMMAND" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = NEW.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "DELETE_TRIGGER_ENDPOINT_TYPE_COMMAND" AFTER DELETE ON "ENDPOINT_TYPE_COMMAND" BEGIN 
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = OLD.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "INSERT_TRIGGER_ENDPOINT_TYPE_EVENT" AFTER INSERT ON "ENDPOINT_TYPE_EVENT" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = NEW.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "UPDATE_TRIGGER_ENDPOINT_TYPE_EVENT" AFTER UPDATE ON "ENDPOINT_TYPE_EVENT" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = NEW.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "DELETE_TRIGGER_ENDPOINT_TYPE_EVENT" AFTER DELETE ON "ENDPOINT_TYPE_EVENT" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = ( SELECT SESSION_REF FROM ENDPOINT_TYPE WHERE ENDPOINT_TYPE_ID = OLD.ENDPOINT_TYPE_REF );
END;

CREATE TRIGGER IF NOT EXISTS "INSERT_TRIGGER_PACKAGE_EXTENSION_VALUE" AFTER INSERT ON "PACKAGE_EXTENSION_VALUE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "UPDATE_TRIGGER_PACKAGE_EXTENSION_VALUE" AFTER UPDATE ON "PACKAGE_EXTENSION_VALUE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = NEW.SESSION_REF;
END;

CREATE TRIGGER IF NOT EXISTS "DELETE_TRIGGER_PACKAGE_EXTENSION_VALUE" AFTER DELETE ON "PACKAGE_EXTENSION_VALUE" BEGIN
  UPDATE SESSION SET DIRTY = 1 WHERE SESSION_ID = OLD.SESSION_REF;
END;
