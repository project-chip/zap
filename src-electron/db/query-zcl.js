...
export function selectEndpointTypeReportableAttributeByEndpointId(
  ...
  return DbApi.dbAll(
    db,
    `SELECT ENDPOINT_TYPE_REF, ATTRIBUTE_REF, INCLUDED_REPORTABLE, MIN_INTERVAL, MAX_INTERVAL, REPORTABLE_CHANGE FROM ENDPOINT_TYPE_ATTRIBUTE WHERE ENDPOINT_TYPE_REF = ? ORDER BY ATTRIBUTE_REF`,
    [endpointTypeId]
