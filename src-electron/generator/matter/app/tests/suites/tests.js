...
function getManualTests() {
  ...
  const GeneralCommissioning = ['Test_TC_CGEN_2_2', 'Test_TC_CGEN_2_4']
  ...
  const LevelControl = ['Test_TC_LVL_2_3', 'Test_TC_LVL_7_1', 'Test_TC_LVL_8_1']

  const OnOff = ['Test_TC_OO_2_3', 'Test_TC_OO_3_1', 'Test_TC_OO_3_2']

  const RelativeHumidityMeasurement = ['Test_TC_RH_2_2', 'Test_TC_RH_3_1']

  const Switch = ['Test_TC_SWTCH_2_2', 'Test_TC_SWTCH_3_1', 'Test_TC_SWTCH_3_2']
  ...
  const UserLabel = ['Test_TC_ULABEL_3_1']
...
function getTests() {
  ...
  const EthernetNetworkDiagnostics = ['Test_TC_DGETH_2_1', 'Test_TC_DGETH_2_2']
  ...
  const Switch = ['Test_TC_SWTCH_1_1', 'Test_TC_SWTCH_2_1']
