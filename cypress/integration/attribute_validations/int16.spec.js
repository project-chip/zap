...
describe('Testing INT16U type validation', () => {
  ...
  it(
    ...
    () => {
      cy.fixture('data').then((data) => {
        cy.get(
          `[data-test="attribute-input-${data.attribute7}"] > .q-field > .q-field__inner > .q-field__control > .q-field__control-container > input`
        )
          .clear({ force: true })
  ...
  it(
    ...
    () => {
      cy.fixture('data').then((data) => {
        cy.get(
          `[data-test="attribute-input-${data.attribute7}"] > .q-field > .q-field__inner > .q-field__bottom > .q-field__messages > div`
